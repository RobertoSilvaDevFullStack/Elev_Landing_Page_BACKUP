...
export default function App({ Component, pageProps }: AppProps) {
  ...
  const FACEBOOK_PIXEL_ID = process.env.NEXT_PUBLIC_FACEBOOK_PIXEL_ID || '669854672792093';
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="ELEV Park Sacomã II - Apartamentos MCMV" />
        <meta property="og:description" content="Apartamentos a 3 min da Estação Sacomã com entrada via FGTS. Plantas de 25m² a 37m² com suíte." />
        ...
        <meta property="twitter:title" content="ELEV Park Sacomã II - Apartamentos MCMV" />
        <meta property="twitter:description" content="Apartamentos a 3 min da Estação Sacomã com entrada via FGTS." />
